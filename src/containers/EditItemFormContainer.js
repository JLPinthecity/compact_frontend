...
class EditItemFormContainer extends React.Component {
    ...
    render(){
        return (
            ...
            <br/>
            <button className="btn" onClick={this.handleClick}>Delete item</button>
            </>
...
export default connect(null, { patchItem, setEditItemForm, deleteItem })(EditItemFormContainer)
