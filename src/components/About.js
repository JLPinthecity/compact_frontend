      ...
      <div className="about-main">
        <div className="row one">
          ...
          <div className="column right">
            ...
            dignissim sodales ut. Lorem ipsum dolor sit amet consectetur. Nullam
            vehicula ipsum a arcu cursus. Sed lectus vestibulum mattis
            ...
            proin. Sed arcu non odio euismod lacinia. Urna molestie at elementum
            eu. Quis enim lobortis scelerisque fermentum dui faucibus. Ipsum
            dolor sit amet consectetur adipiscing elit pellentesque habitant
            morbi. Suspendisse interdum consectetur libero id faucibus nisl. Sed
            ...
            Tellus in hac habitasse platea. Dolor sed viverra ipsum nunc
            aliquet. Pretium fusce id velit ut. Ullamcorper dignissim cras
            tincidunt lobortis.
          </div>
        </div>
        ...
        <div className="row two">
          <div className="column left">
            ...
            penatibus et magnis dis parturient. Ipsum faucibus vitae aliquet nec
            ullamcorper sit amet risus nullam. Mi bibendum neque egestas congue
            quisque egestas diam. Quis viverra nibh cras pulvinar mattis nunc
            sed. Curabitur vitae nunc sed velit. Vitae justo eget magna
            fermentum iaculis. Duis tristique sollicitudin nibh sit amet commodo
            nulla facilisi. Vitae turpis massa sed elementum tempus egestas sed
            sed risus. Amet facilisis magna etiam tempor orci eu. Facilisi cras
            fermentum odio eu feugiat. Pulvinar mattis nunc sed blandit libero
        ...
        <div className="row bottom">
          ...
          <div className="column_2">
            <ul>
              <li>
                You'll break out of every personal rut—whether it's your 9-to-5
                or rinse-and-repeat daily routine. Get ready for new sights,
